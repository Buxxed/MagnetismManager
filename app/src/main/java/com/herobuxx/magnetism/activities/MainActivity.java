...
import com.herobuxx.magnetism.BuildConfig;
import com.herobuxx.magnetism.R;
import com.herobuxx.magnetism.database.tools.profiles.Profiles;
import com.herobuxx.magnetism.services.profile.Tile;
...
import com.herobuxx.magnetism.utils.kernel.cpu.CPUBoost;
import com.herobuxx.magnetism.utils.kernel.cpu.CPUFreq;
import com.herobuxx.magnetism.utils.kernel.cpu.MSMPerformance;
import com.herobuxx.magnetism.utils.kernel.cpu.Temperature;
import com.herobuxx.magnetism.utils.kernel.cpuhotplug.Hotplug;
import com.herobuxx.magnetism.utils.kernel.cpuhotplug.QcomBcl;
...
import com.herobuxx.magnetism.utils.kernel.misc.Vibration;
            ...
            if (result == 0) {
                try {
                    ApplicationInfo applicationInfo = getPackageManager().getApplicationInfo(
                            "com.herobuxx.magnetismdonate", 0);
    ...
    private static class LoadingTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean donationValid) {
            ...
            if (donationValid && mLicensedCached) {
                ...
                intent.setComponent(new ComponentName("com.herobuxx.magnetismdonate",
                        "com.herobuxx.magnetismdonate.MainActivity"));
